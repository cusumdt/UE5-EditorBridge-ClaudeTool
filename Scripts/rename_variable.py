...
member parent to the new owner class. Then refreshes nodes, rewires orphaned pins, compiles
and saves.
...
"""
import unreal
from editorbridge import args, arg_list, log, load_blueprint, compile_and_report, load_class
...
for bp in [owner] + deps:
    ...
    any_errors |= compile_and_report(bp, save=True)
